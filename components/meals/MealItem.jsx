  ...
  return (
    <article className='flex flex-col text-[#ddd6cb] justify-between h-100vh rounded-md overflow-hidden transition-all ease-in-out duration-300' style={{boxShadow: '0 0 12px rgba(0, 0, 0, 0.3)', background: 'linear-gradient(90deg, #2c1e19, #25200f)'}}>
      <header>
        ...
        <div className='p-2'>
          <h2 className='m-0 text-[1.5rem] font-sans-Montserrat'>{title}</h2>
      ...
      <div className='flex flex-col justify-between h-100vh'>
        ...
        <div className='p-4 text-right'>
          <Link href={`/meals/${slug}`} className='inline-block mt-4 p-2 rounded-sm text-white font-bold hover:bg-gradient-to-r from-[#fd4715] to-[#f9b241] hover:shadow-[0_0_18px_rgba(248,190,42,0.8)]' style={{background: 'linear-gradient(90deg, #f9572a, #ff9b05)'}}>View Details</Link>
        </div>
      </div>
    </article>
  );
